...
const INITIAL_PIECES: Piece[] = [
  ...
  { id: 'w-bishop1', type: 'bishop', color: 'white', position: { row: 1, col: 3 }, cards: [] },
  { id: 'w-bishop2', type: 'bishop', color: 'white', position: { row: 1, col: 4 }, cards: [] },
  { id: 'w-knight1', type: 'knight', color: 'white', position: { row: 2, col: 2 }, cards: [] },
  ...
  { id: 'w-rook2', type: 'rook', color: 'white', position: { row: 1, col: 7 }, cards: [] },
  { id: 'w-queen', type: 'queen', color: 'white', position: { row: 3, col: 3 }, cards: [] },
  
  // Black pieces
  { id: 'b-king', type: 'king', color: 'black', position: { row: 7, col: 3 }, cards: [] },
  { id: 'b-bishop1', type: 'bishop', color: 'black', position: { row: 6, col: 3 }, cards: [] },
  { id: 'b-bishop2', type: 'bishop', color: 'black', position: { row: 6, col: 4 }, cards: [] },
  { id: 'b-knight1', type: 'knight', color: 'black', position: { row: 5, col: 2 }, cards: [] },
  ...
  { id: 'b-rook2', type: 'rook', color: 'black', position: { row: 6, col: 7 }, cards: [] },
